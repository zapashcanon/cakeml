...
val firstSet_nEbase = Store_thm(
  ...
  ``firstSet cmlG [NT (mkNT nEbase)] =
      {LetT; LparT; LbrackT} ∪ firstSet cmlG [NT (mkNT nFQV)] ∪ {WordT w | T}
...
val firstSet_nPbase = Store_thm(
  ...
  ``firstSet cmlG (NN nPbase :: rest) =
      {LparT; UnderbarT; LbrackT}  ∪ {WordT w | T}
      ∪ {IntT i | T } ∪ {StringT s | T } 
...
val stoppers_def = Define`
  ...
  (stoppers nPatternList =
     UNIV DIFF ({CommaT; LparT; UnderbarT; LbrackT; SymbolT "::"} ∪
                {IntT i | T} ∪ { StringT s | T } ∪ { WordT w | T } ∪
                firstSet cmlG [NN nV] ∪ firstSet cmlG [NN nConstructorName])) ∧
...
val completeness = store_thm(
  ...
  >- (print_tac "nEbase" >> note_tac "** Slow nEbase beginning" >> stdstart
      ...
      >- (note_tac "Ebase:Eseq (not Word)" >> simp[peg_eval_tok_NONE])
      ...
      >- (note_tac "Ebase:() (not Word)" >> simp[peg_eval_tok_NONE])
      >- (note_tac "Ebase:FQV" >>
          ...
          `¬isWord h ∧ ¬isInt h ∧ ¬isString h 
           ∧ h ≠ LparT ∧ h ≠ LetT ∧ h ≠ LbrackT`
      ...
      >- (note_tac "Ebase:word (not Int)" >> simp[peg_eval_tok_NONE])
      >- (note_tac "Ebase:word (not String)" >> simp[peg_eval_tok_NONE])
      ...
      >- (note_tac "Ebase:let (not Word)" >> simp[peg_eval_tok_NONE])
